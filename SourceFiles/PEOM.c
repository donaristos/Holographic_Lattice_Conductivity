...
elem[0]=
Ax.diff(d10,i-1,j)-Ax.diff(d10,i,j)
;
elem[1]=
h11.diff(d10,i-1,j)-h11.diff(d10,i,j)
;
elem[2]=
Dh.diff(d10,i-1,j)-Dh.diff(d10,i,j)
;
elem[3]=
htt.diff(d10,i-1,j)-htt.diff(d10,i,j)
;
elem[4]=
h22.diff(d10,i-1,j)-h22.diff(d10,i,j)
;
elem[5]=
ht1.diff(d10,i-1,j)-ht1.diff(d10,i,j)
;
elem[6]=
